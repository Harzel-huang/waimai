      ...
      <div class="content">
        <div class="content-left" @click="toggleShow">
          <div class="logo-wrapper">
            <div class="logo" :class="{highlight: totalCount,highblue: totalCount}">
      ...
      <transition name="move">
        <div class="shopcart-list" v-show="listShow">
          ...
          <div class="list-content">
            <ul>
              <li class="food" v-for="(Info, index) in cartFoods" :key="index">
                <span class="name">{{Info.name}}</span>
                <div class="price">
                  <span>￥{{Info.price}}</span>
                </div>
                <div class="cartcontrol-wrapper">
                  <CartControl :food="Info" />
                </div>
              </li>
            </ul>
          </div>
  ...
  methods: {
    ...
    cleanCart() {
      MessageBox.confirm("确定清空购物车?").then(action => {
        this.$store.commit('cleanShopCart');
      });
    }
  },
  components: {
